...
class AccountInfoViewModelFactory @Inject constructor(val useCase: GetAccountInfoUseCase,
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return AccountInfoViewModel(useCase,refreshTokenUseCase,saveAuthResponseUseCase,logOutUseCase,uploadProfilePictureUseCase,setAccountInfoUseCase,verifyEmailUseCase,sharedPrefsModel) as T
    }
}