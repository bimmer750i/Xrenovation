...
class SignUpByEmailViewModelFactory @Inject constructor(val useCase: SignUpByEmailUseCase, val captchaUseCase: VerifyCaptchaUseCase,
                                                        val saveAuthResponseUseCase: SaveAuthResponseUseCase) : ViewModelProvider.Factory {

    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return SignUpByEmailViewModel(useCase,captchaUseCase,saveAuthResponseUseCase) as T
    }
